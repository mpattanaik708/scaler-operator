...
// NamespacedName is a struct to hold the name and namespace of a Kubernetes object
...
// Ensure Scaler implements runtime.Object
func (s *Scaler) GetObjectKind() schema.ObjectKind {
	return &s.TypeMeta
}
